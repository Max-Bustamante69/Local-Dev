...
export default class OrthofixOrderFormPatientInformation extends NavigationMixin(
  LightningElement
) {
  @api formData;
  @api picklistOptions;
  ...
  @track phone = "";
  @track emergencyPhoneNumber = "";
  @track alternatePhoneNumber = "";
  ...
  connectedCallback() {
    ...
    this.navigateToPhysicianListview =
      this.sfdcbaseUrl + this.label.navigatetocontactlistview;
  ...
  get displaySalesRepField() {
    ...
    return (
      this.picklistOptions.territoryManagers !== null &&
      this.picklistOptions.territoryManagers !== undefined &&
      this.picklistOptions.territoryManagers !== "" &&
      this.picklistOptions.territoryManagers.length > 0
    );
  }
  ...
  get prescriberAddress() {
    ...
    if (this.prescriberDataFromLookup) {
      ...
      this.formData &&
      this.formData.patientInformation &&
      this.formData.patientInformation.prescriber
    ) {
      return {
  ...
  get favPhysiciansPicklistOptions(){
    const favPhysicians = this.picklistOptions.favoritePhysicians.map((el) => {
        return {
        label: el.contact.name + " - " + el.contact.npi,
        value: el.contact.id,
      };
    });
    return favPhysicians;
  }
  ...
  handleAddToFavoritesClick() {
    ...
    showSuccess(
      this,
      "Added as Favorite",
      "Note : Favorite will be saved upon order save"
    );
  }
  ...
  handleChangeFavoritePhysicians(event) {
    ...
    let contact;
    console.log(
      "this.picklistOptions.favoritePhysicians",
      JSON.stringify(this.picklistOptions.favoritePhysicians)
    );
  ...
  formattedPhoneNumber(number) {
    ...
    // Apply the formatting (___)-___-____
  ...
  get primaryCarePhoneNumber() {
    if (this.formData.patientInformation.primaryCarePhysician.phone) {
      console.log(
        "formData.patientInformation.primaryCarePhysician.phone",
        this.formData.patientInformation.primaryCarePhysician.phone
      );
      console.log("phoneNumber", phoneNumber);
      return this.formattedPhoneNumber(phoneNumber);
    }
  }
  ...
  pupulatePrescriberData(contact) {
    ...
    if (contact.id) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.id",
            value: contact.id,
          },
        })
      );
    ...
    this.dispatchEvent(
      new CustomEvent("inputchange", {
        detail: {
          fieldName: "patientInformation.prescriber.isFavorite",
    ...
    if (contact.firstName) {
      ...
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.prescriber.firstName"]'
      ).value = contact.firstName;
    }
    if (contact.lastName) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.lastName",
            value: contact.lastName,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.prescriber.lastName"]'
      ).value = contact.lastName;
    }
    // if(contact.phone){
    ...
    if (contact.npi) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.npi",
            value: contact.npi,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.prescriber.npi"]'
      ).value = contact.npi;
    }
    if (contact.licence) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.licence",
            value: contact.licence,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.prescriber.licence"]'
      ).value = contact.licence;
    }
  ...
  pupulatePrimaryCarePhysicianData(contact) {
    ...
    if (contact.id) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.primaryCarePhysician.id",
            value: contact.id,
          },
        })
      );
    ...
    if (contact.firstName || contact.lastName) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.primaryCarePhysician.name",
            value: fullName,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.primaryCarePhysician.name"]'
      ).value = fullName;
    }
    if (contact.phone) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.primaryCarePhysician.phone",
            value: contact.phone,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.primaryCarePhysician.phone"]'
      ).value = contact.phone;
    }
    if (contact.npi) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.primaryCarePhysician.npi",
            value: contact.npi,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.primaryCarePhysician.npi"]'
      ).value = contact.npi;
    }
    if (contact.refferalcoordinator) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName:
              "patientInformation.primaryCarePhysician.refferalcoordinator",
            value: contact.refferalcoordinator,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.primaryCarePhysician.refferalcoordinator"]'
      ).value = contact.refferalcoordinator;
    }
    if (contact.fax) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.primaryCarePhysician.fax",
            value: contact.fax,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.primaryCarePhysician.fax"]'
      ).value = contact.fax;
    }
  }
  selectedAddRecord = "";
  ...
  handlePhoneInput(event) {
    ...
    this.handleInputChange(event);
    input = this.formattedPhoneNumber(input);

    if (name == "patientInformation.phone") {
      this.phone = input;
    } else if (name == "patientInformation.emergencyContact.phone") {
      this.emergencyPhoneNumber = input;
    } else if (name == "patientInformation.alternateContact.phone") {
      this.alternatePhoneNumber = input;
    }
  ...
  get prescriberPhone() {
    console.log(
      "this.formData.patientInformation.physicianPhone",
      this.formData.physicianPhone
    );
    if (this.prescriberPhoneDataFromLookup) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.phone",
            value: this.formData.physicianPhone,
          },
        })
      );
      return {
        phone: this.formattedPhoneNumber(this.formData.physicianPhone),
      };
    } else {
      return {
        phone: null,
  ...
  populateData(zipcode) {
    ...
    if (zipcode.mainField) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.postalCode",
            value: zipcode.mainField,
          },
        })
      );
    }
    ...
    if (zipcode.city) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: { fieldName: "patientInformation.city", value: zipcode.city },
        })
      );
      console.log(
        "this.formData.patientInformation.city",
        this.formData.patientInformation.city
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.city"]'
      ).value = zipcode.city;
    }
    if (zipcode.statecode) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.province",
            value: zipcode.statecode,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.state"]'
      ).value = zipcode.statecode;
    }
    if (zipcode.county) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.county",
            value: zipcode.county,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.county"]'
      ).value = zipcode.county;
    }
    if (zipcode.country) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.country",
            value: zipcode.country,
          },
        })
      );
      this.template.querySelector(
        'lightning-input[data-name="patientInformation.country"]'
      ).value = zipcode.country;
    }
  }
  ...
  populatePhoneData(phone) {
    ...
    if (phone.id) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.phoneId",
            value: phone.id,
          },
        })
      );
  ...
  populateaddressData(address) {
    ...
    if (address.id) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.addressId",
            value: address.id,
          },
        })
      );
    ...
    if (address.mainField) {
      ...
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.street",
            value: address.mainField,
          },
        })
      );
    }
    ...
    if (address.city) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.city",
            value: address.city + ", ",
          },
        })
      );
    ...
    if (address.country) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.country",
    ...
    if (address.statecode) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.province",
    ...
    if (address.postalCode) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.postalCode",
    ...
    if (address.address2) {
      this.dispatchEvent(
        new CustomEvent("inputchange", {
          detail: {
            fieldName: "patientInformation.prescriber.address2",
  ...
  handleAddressChange(event) {
    ...
    this.dispatchEvent(
      new CustomEvent("inputchange", {
        detail: { fieldName: name + ".street", value: event.target.street },
      })
    );
    this.dispatchEvent(
      new CustomEvent("inputchange", {
        detail: { fieldName: name + ".city", value: event.target.city + "," },
      })
    );
    this.dispatchEvent(
      new CustomEvent("inputchange", {
        detail: {
          fieldName: name + ".province",
          value: event.target.province + ", ",
        },
      })
    );
    this.dispatchEvent(
    ...
    this.dispatchEvent(
      new CustomEvent("inputchange", {
        detail: {
          fieldName: name + ".postalCode",
          value: event.target.postalCode,
        },
      })
    );
  }
